...
func (r *Reposytory) ListTasks(ctx context.Context, db Queryer, id entity.UserID) (entity.Tasks, error) {
	tasks := entity.Tasks{}
	sql := `SELECT
...
func (r *Reposytory) AddTask(ctx context.Context, db Execer, t *entity.Task) error {
